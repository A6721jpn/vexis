...
sys.path.append(
    r"c:\github_repo\vexis\worktrees\vexis-rust-vulkan\src\libs\vexis_vulkan_core"
)
import vexis_vulkan_core


def main():
    parser = vexis_vulkan_core.XpltFastParser(
        r"c:\github_repo\vexis\temp\example_1.xplt"
    )
